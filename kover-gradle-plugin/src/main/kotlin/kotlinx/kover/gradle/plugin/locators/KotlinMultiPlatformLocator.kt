...
internal fun Project.locateKotlinMultiplatformVariants(): VariantSources {
    ...
    return VariantSources(jvm, androids)
}
...
private fun Project.locateJvmVariant(kotlinExtension: DynamicBean): JvmVariantSource? {
...
private fun Project.extractJvmVariant(target: DynamicBean): JvmVariantSource {
    ...
    return JvmVariantSource(tests, compilations)
}
