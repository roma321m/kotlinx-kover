...
package kotlinx.kover.gradle.plugin.settings
...
internal object KoverParametersProcessor {
    fun process(settingsExtension: KoverSettingsExtensionImpl, providers: ProviderFactory) {
        ...
        settingsExtension.main.includedProjects.readAppendableArgument(providers, "kover.classes.from")
        settingsExtension.main.excludedProjects.readAppendableArgument(providers, "kover.classes.from.excludes")
        settingsExtension.main.excludedClasses.readAppendableArgument(providers, "kover.classes.excludes")
    }
