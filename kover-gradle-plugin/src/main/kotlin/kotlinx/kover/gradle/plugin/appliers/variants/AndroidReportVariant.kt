...
internal class AndroidReportVariant(
    ...
    init {
        val androidDetails = variantSource.details

        producerConfiguration.configure {
            attributes {
                attribute(VariantOriginAttr.ATTRIBUTE, project.objects.named(ReportsVariantType.ANDROID.name))
