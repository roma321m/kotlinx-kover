...
import kotlinx.kover.gradle.plugin.sources.AndroidDetails
...
private fun Project.extractAndroidKit(
    ...
    val details = AndroidDetails(variantName, buildTypeName, flavors, fallbacks, missingDimensions)
    return AndroidVariantSource(tests, compilations, details)
}
